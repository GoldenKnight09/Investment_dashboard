...
app.layout = html.Div(children = [html.Div(html.H2('Stock/Index/Commodity/Treasury Investing Dashboard',
                                  ...
                                  html.Div(dbc.Tabs(children = [dbc.Tab(children = [dbc.Col(children = [sup_func.generate_dropdown_menu(stock_dict_by_group[group_name], group_name) for group_name in stock_group_list])],
                                                                ...
                                                                dbc.Tab(children = [dbc.Col(children = dbc.DropdownMenu(label = 'Select an Index...',
                                                                                                                        ...
                                                                                                                        children = [sup_func.generate_dropdown_menu_item(dropdown_item) for dropdown_item in index_df.index.to_list()]))],
                                                                        label = 'Indices',
                                                                        style = {'margin-left':'3px'}),
                                                                dbc.Tab(children = [],
                                                                        label = 'Commodities',
